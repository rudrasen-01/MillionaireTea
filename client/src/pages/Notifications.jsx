...
export default function Notifications() {
  ...
  // Show the same compact recent notifications as Profile: filter and sort tea/points related
  const filteredNotifications = (notifications || [])
    .filter(n => {
      if (n.adminNotification) return false;
  ...
  const recentToShow = filteredNotifications.slice(0, 2);
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {(!notifications || notifications.length === 0) && (
          ...
          <div className="space-y-3 mt-4">
              {recentToShow && recentToShow.map(n => {
                  const id = n.id || n._id;
