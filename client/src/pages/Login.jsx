...
export function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-cream via-warmWhite to-cream relative">
      {/* Mobile Back Button */}
      <button
        onClick={() => {
          try { navigate(-1); } catch (e) { navigate('/'); }
        }}
        className="absolute top-4 left-4 z-20 bg-beige/80 text-darkBrown px-3 py-2 rounded-lg shadow-sm"
        aria-label="Go back"
      >
        ← Back
      </button>
