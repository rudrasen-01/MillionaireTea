...
export function LandingPage({ onGetStarted }) {
      ...
      : [
          {
            ...
            location: "Mumbai",
            content:
              "This chai reminds me of my grandmother's recipe. Absolutely authentic and soul-warming!",
            rating: 5,
            initials: "PS",
          },
          {
            ...
            location: "Delhi",
            content:
              "The masala chai is simply outstanding. Perfect blend of spices that hits all the right notes.",
            rating: 5,
            initials: "RK",
          },
          {
            ...
            location: "Bangalore",
            content:
              "Every morning starts with ChaiTime now. Can't imagine my day without it!",
            rating: 5,
            initials: "AG",
          },
          {
            ...
            location: "Chennai",
            content:
              "The kadak chai is exactly how I like it — strong, aromatic, and full of character!",
            rating: 5,
            initials: "VN",
          },
        ];
  ...
  return (
    <div className="h-full font-quicksand bg-warmWhite text-darkBrown overflow-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <a href="#hero" className="flex items-center space-x-2">
              <span className="font-baloo text-xl sm:text-2xl font-bold text-caramel">
                MILLIONAIRE TEA
              </span>
            </a>
            ...
            <div className="hidden md:flex items-center space-x-6">
              <a
                href="#how-it-works"
                className="text-darkBrown hover:text-caramel transition-colors font-medium text-sm"
              >
                How It Works
              </a>
              <a
            ...
            >
              {isMenuOpen ? (
                ...
                <Menu className="w-6 h-6 text-darkBrown" />
              )}
            </button>
          </div>
            ...
            <div className="md:hidden pb-4">
              <div className="flex flex-col space-y-3">
                <a
                  ...
                  className="py-2 px-4 rounded-lg hover:bg-beige/30 transition-colors font-medium"
                >
                  How It Works
                </a>
                <a
      ...
      <section
        id="hero"
        className="relative min-h-screen bg-gradient-to-br from-cream via-warmWhite to-cream overflow-hidden pt-0 sm:pt-4"
      >
        ...
        <div
          className="absolute top-40 right-20 twinkle-animation opacity-30"
        ...
        <div
          className="absolute bottom-40 left-20 twinkle-animation opacity-20"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
            ...
            <div className="flex-1 text-center lg:text-left fade-in-up">
              <p className="text-xs sm:text-sm font-bold text-caramel mb-2 uppercase tracking-wider">
                Premium Rank-Based Rewards
              </p>
              <h1 className="font-baloo text-3xl sm:text-4xl lg:text-5xl font-bold text-darkBrown mb-3 leading-tight">
                Turn Every Tea Into{" "}
                <span className="text-caramel">Rewards</span>
              </h1>
              <p className="text-sm sm:text-base text-darkBrown/70 mb-6 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                Earn points with every purchase, track your rank in real-time,
                and win guaranteed milestone rewards. Transparent, automated,
                and fair!
              </p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                ...
                <a
                  href="#how-it-works"
                  className="border-2 border-caramel/70 text-darkBrown px-6 py-3 rounded-full font-semibold text-base hover:bg-caramel hover:text-cream transition-all text-center"
                >
                  How It Works
                </a>
              </div>
            ...
            <div className="flex-1 relative flex justify-center items-center">
              ...
              <div className="absolute -top-4 sm:top-0 left-1/2 transform -translate-x-1/2 lg:left-auto lg:right-0 lg:translate-x-0 wobble-animation z-10">
                <div className="bg-gradient-to-br from-beige to-cream border-2 border-caramel rounded-3xl px-6 py-4 shadow-xl relative">
                  <p className="font-baloo text-xl sm:text-2xl text-darkBrown font-bold whitespace-nowrap">
                    Ek aur milegii? ☕
                  </p>
                  {/* Speech bubble tail */}
              ...
              <div className="float-animation mt-16 sm:mt-20">
                <svg
                  viewBox="0 0 300 350"
                  className="w-64 h-72 sm:w-80 sm:h-96"
                  fill="none"
                >
                  {/* Steam lines */}
                  ...
                  <path
                    d="M70 100 L85 280 Q150 300 215 280 L230 100"
                    fill="#F5E6D3"
                    stroke="#B87333"
                    strokeWidth="4"
                  />
                  ...
                  <path
                    d="M90 140 Q100 150 110 140 Q120 130 130 140 Q140 150 150 140 Q160 130 170 140 Q180 150 190 140 Q200 130 210 140"
                    stroke="#B87333"
                    strokeWidth="2"
                    fill="none"
                    strokeDasharray="5,5"
                  />
                  <path
                    d="M95 180 Q105 190 115 180 Q125 170 135 180 Q145 190 155 180 Q165 170 175 180 Q185 190 195 180 Q205 170 205 180"
                    stroke="#D8B08C"
                    strokeWidth="2"
                    fill="none"
                  />
                  ...
                  {/* Heart decoration */}
                  <path
                    d="M145 220 C140 215 130 215 130 225 C130 235 145 245 150 250 C155 245 170 235 170 225 C170 215 160 215 155 220 L150 225 L145 220"
                    fill="#B87333"
                  />

                  {/* Handle */}
                  <path
                    d="M230 130 Q280 150 280 200 Q280 250 230 260"
                    stroke="#B87333"
                    strokeWidth="8"
                    fill="none"
                    strokeLinecap="round"
                  ...
                  <path
                    d="M100 200 L102 205 L107 205 L103 208 L105 213 L100 210 L95 213 L97 208 L93 205 L98 205 Z"
                    fill="#B87333"
                  />
                  <path
                    d="M200 160 L202 165 L207 165 L203 168 L205 173 L200 170 L195 173 L197 168 L193 165 L198 165 Z"
                    fill="#D8B08C"
                  />
                </svg>
              </div>
      ...
      <section
        id="how-it-works"
        className="py-12 sm:py-16 bg-gradient-to-b from-cream to-warmWhite relative"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="font-baloo text-3xl sm:text-4xl font-bold text-darkBrown mb-2">
              How It Works
            </h2>
            <p className="text-darkBrown/70 text-base max-w-2xl mx-auto">
              A clear, fair flow that rewards purchases and rotates winners
              predictably
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              >
                ...
                <h3 className="font-baloo text-lg font-bold text-darkBrown mb-2">
                  {step.title}
                </h3>
      ...
      <section
        id="features"
        className="py-12 sm:py-16 bg-gradient-to-b from-warmWhite to-cream relative"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="font-baloo text-3xl sm:text-4xl lg:text-5xl font-bold text-darkBrown mb-2">
              Why Choose Our Rewards Platform?
            </h2>
            <p className="text-darkBrown/70 text-lg max-w-2xl mx-auto">
              Transparent, automated, and fair reward system for every tea lover
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div className="feature-card bg-gradient-to-br from-cream to-warmWhite border-2 border-caramel/40 rounded-3xl p-6 sm:p-8 text-center shadow-xl hover:shadow-2xl transition-all hover:border-caramel">
              ...
              <h3 className="font-baloo text-xl sm:text-2xl font-bold text-darkBrown mb-2 sm:mb-3">
                Transparent Rank-Based Rewards
              </h3>
              <p className="text-darkBrown/70 text-sm sm:text-base">
                Your rank is automatically assigned based on registration order.
                Complete transparency with no manual manipulation.
              </p>
            </div>
            ...
            <div className="feature-card bg-gradient-to-br from-cream to-warmWhite border-2 border-caramel/40 rounded-3xl p-6 sm:p-8 text-center shadow-xl hover:shadow-2xl transition-all hover:border-caramel">
              <div
                className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-caramel to-darkBrown rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 pulse-animation shadow-md"
                style={{ animationDelay: "0.2s" }}
              >
                <Coffee className="w-8 h-8 sm:w-10 sm:h-10 text-cream" />
              </div>
              <h3 className="font-baloo text-xl sm:text-2xl font-bold text-darkBrown mb-2 sm:mb-3">
                Earn Points with Every Tea
              </h3>
              <p className="text-darkBrown/70 text-sm sm:text-base">
                Every tea purchase adds reward points. The more you purchase,
                the more you earn!
              </p>
            </div>
            ...
            <div className="feature-card bg-gradient-to-br from-cream to-warmWhite border-2 border-caramel/40 rounded-3xl p-6 sm:p-8 text-center shadow-xl hover:shadow-2xl transition-all hover:border-caramel">
              ...
              <p className="text-darkBrown/70 text-sm sm:text-base">
                Top-ranked eligible user receives rewards when sales milestone
                is achieved. Structured and motivating!
              </p>
            </div>
            ...
            <div className="feature-card bg-gradient-to-br from-cream to-warmWhite border-2 border-caramel/40 rounded-3xl p-6 sm:p-8 text-center shadow-xl hover:shadow-2xl transition-all hover:border-caramel">
              ...
              <p className="text-darkBrown/70 text-sm sm:text-base">
                Rank reshuffling to reward distribution—everything is fully
                automated!
              </p>
            </div>
            ...
            <div className="feature-card bg-gradient-to-br from-cream to-warmWhite border-2 border-caramel/40 rounded-3xl p-6 sm:p-8 text-center shadow-xl hover:shadow-2xl transition-all hover:border-caramel">
              ...
              <p className="text-darkBrown/70 text-sm sm:text-base">
                Modern tech stack ensuring secure authentication, real-time
                updates, and safe reward management.
              </p>
            </div>
            ...
            <div className="feature-card bg-gradient-to-br from-cream to-warmWhite border-2 border-caramel/40 rounded-3xl p-6 sm:p-8 text-center shadow-xl hover:shadow-2xl transition-all hover:border-caramel">
              ...
              <p className="text-darkBrown/70 text-sm sm:text-base">
                After receiving a reward, winner moves to last rank—giving
            ...
            <div className="feature-card bg-gradient-to-br from-cream to-warmWhite border-2 border-caramel/40 rounded-3xl p-6 sm:p-8 text-center shadow-xl hover:shadow-2xl transition-all hover:border-caramel">
              ...
              <p className="text-darkBrown/70 text-sm sm:text-base">
                Track your rank, points, teas purchased, and eligibility.{" "}
                <strong className="text-darkBrown">Admin</strong> monitors sales
                in real-time.
              </p>
            </div>
            ...
            <div className="feature-card bg-gradient-to-br from-cream to-warmWhite border-2 border-caramel/40 rounded-3xl p-6 sm:p-8 text-center shadow-xl hover:shadow-2xl transition-all hover:border-caramel">
              ...
              <p className="text-darkBrown/70 text-sm sm:text-base">
                No lucky draws! Rewards automatically distributed to top-ranked
                user once milestone is achieved.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="relative">
        ...
        >
          <path
            d="M0 0L60 10C120 20 240 40 360 46.7C480 53 600 47 720 43.3C840 40 960 40 1080 43.3C1200 47 1320 53 1380 56.7L1440 60V100H0V0Z"
            fill="#F5E6D3"
          />
        </svg>
      </div>
      ...
      <section
        id="about"
        className="py-12 sm:py-16 bg-gradient-to-br from-warmWhite via-cream to-beige/30 relative"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
                  ...
                  >
                    ...
                    <g transform="translate(60, 200)">
                      ...
                      <g transform="translate(80, 30)">
                        <path
                          d="M0 -20 L5 -5 L20 -5 L8 5 L13 20 L0 10 L-13 20 L-8 5 L-20 -5 L-5 -5 Z"
                          fill="#4A2C2A"
                        />
                    ...
                    <g transform="translate(150, 80)">
                      ...
                      <path
                        d="M5 10 L15 120 Q50 135 85 120 L95 10"
                        fill="#F5E6D3"
                        stroke="#B87333"
                        strokeWidth="3"
                      />
                      ...
                      <path
                        d="M95 30 Q130 50 130 80 Q130 110 95 115"
                        stroke="#B87333"
                        strokeWidth="5"
                        fill="none"
                        strokeLinecap="round"
                      ...
                      {/* Heart on cup */}
                      <path
                        d="M45 70 C42 67 35 67 35 73 C35 79 45 85 50 88 C55 85 65 79 65 73 C65 67 58 67 55 70 L50 73 L45 70"
                        fill="#B87333"
                      />
                    </g>
            ...
            {/* About Text */}
            <div className="flex-1">
              <h2 className="font-baloo text-3xl sm:text-4xl lg:text-5xl font-bold text-darkBrown mb-3">
                Our Story
              </h2>
              ...
              <p className="text-darkBrown/80 text-base sm:text-lg mb-4 sm:mb-6 leading-relaxed">
                Millionaire Tea was born from a simple belief — that a perfect
                cup of tea has the power to bring people together, spark
                conversations, and create memories that last a lifetime.
              </p>
              <p className="text-darkBrown/80 text-base sm:text-lg mb-6 sm:mb-8 leading-relaxed">
                Our journey started in a small kitchen, experimenting with
                traditional recipes and premium spices. Today, we're proud to
                serve thousands of tea lovers who share our passion for
                authentic, soulful tea.
              </p>

              {/* Stats */}
              <div className="grid grid-cols-3 gap-4 sm:gap-6">
                <div className="text-center bg-gradient-to-br from-beige/40 to-transparent rounded-2xl p-3 sm:p-4">
                  <div className="font-baloo text-2xl sm:text-3xl lg:text-4xl font-bold text-caramel drop-shadow">
                    50K+
                  </div>
                  <div className="text-darkBrown font-semibold text-sm sm:text-base">
                    Happy Customers
                  </div>
                </div>
                <div className="text-center bg-gradient-to-br from-beige/40 to-transparent rounded-2xl p-3 sm:p-4">
      ...
      <div className="relative">
        ...
        >
          <path
            d="M0 100L60 90C120 80 240 60 360 53.3C480 47 600 53 720 56.7C840 60 960 60 1080 56.7C1200 53 1320 47 1380 43.3L1440 40V0H0V100Z"
            fill="#F5E6D3"
          />
        </svg>
      </div>
      ...
      <section
        id="testimonials"
        className="py-12 sm:py-16 bg-gradient-to-b from-warmWhite to-cream relative overflow-hidden"
      >
        {/* Background decoration */}
        <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
          <div className="absolute top-20 left-10 text-8xl text-caramel">
            ☕
          </div>
          <div className="absolute bottom-20 right-10 text-8xl text-caramel">
            ☕
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="font-baloo text-3xl sm:text-4xl lg:text-5xl font-bold text-darkBrown mb-2 drop-shadow-sm">
              What Our Tea Lovers Say
            </h2>
            <p className="text-darkBrown/70 text-lg font-semibold max-w-2xl mx-auto">
              Real stories from real tea enthusiasts
            </p>
            {reviewsSummary.count > 0 && (
              <div className="mt-4 flex items-center justify-center gap-4">
                <div className="flex items-center gap-1 text-amber-400">
                  {[...Array(Math.round(reviewsSummary.average || 0))].map(
                    (_, i) => (
                ...
                <div className="text-sm text-darkBrown/60">
                  {reviewsSummary.average.toFixed(1)} average —{" "}
          ...
          <div className="relative">
                ...
                {testimonials.map((testimonial, index) => {
                  ...
                  return (
                    <div
                      ...
                      className="testimonial-card min-w-full sm:min-w-[50%] lg:min-w-[33.333%] p-3 sm:p-4"
                    >
                      <div className="bg-gradient-to-br from-cream to-warmWhite border-2 border-caramel/40 rounded-3xl p-6 sm:p-8 h-full shadow-xl hover:shadow-2xl transition-all hover:border-caramel">
                        <div className="flex items-center mb-4 sm:mb-6">
                          ...
                          <div className="ml-3 sm:ml-4">
                            <h4 className="font-baloo font-bold text-darkBrown text-base sm:text-lg">
                              {testimonial.name}
                            </h4>
                            <p className="text-caramel text-xs sm:text-sm">
                              {location}
                            </p>
                          </div>
                        </div>
                        ...
                        <p className="text-darkBrown/80 text-sm sm:text-base italic leading-relaxed">
            ...
            <div className="flex justify-center mt-4 gap-2">
              {Array.from({ length: Math.min(totalSlides, maxSlide + 1) }).map(
                (_, index) => (
                  <button
                    key={index}
      ...
      <section className="py-12 sm:py-16 bg-gradient-to-br from-darkBrown via-caramel to-darkBrown relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div
            className="absolute bottom-10 right-10 w-60 h-60 bg-beige/10 rounded-full float-animation"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute top-1/2 left-1/4 w-20 h-20 bg-beige/10 rounded-full float-animation"
            style={{ animationDelay: "0.5s" }}
          ></div>
        </div>

        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="font-baloo text-3xl sm:text-4xl lg:text-5xl font-bold text-cream mb-3 drop-shadow-lg">
            Ready for Your Perfect Cup?
          </h2>
          <p className="text-beige text-lg sm:text-xl font-medium mb-6 max-w-2xl mx-auto">
            Join thousands of tea lovers and experience the warmth of authentic
            Indian tea with our rewards program.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
            ...
            <a
              href="#features"
              className="text-cream border-2 border-cream/70 px-8 sm:px-10 py-4 sm:py-5 rounded-full font-baloo font-bold text-lg sm:text-xl hover:bg-cream hover:text-darkBrown transition-all shadow-lg"
            >
              Explore Menu
            </a>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
            ...
            <div className="lg:col-span-2">
              <h3 className="font-baloo text-2xl sm:text-3xl font-bold text-beige mb-4">
                MILLIONAIRE TEA
              </h3>
              <p className="text-cream/90 text-sm sm:text-base mb-6 max-w-md leading-relaxed">
                Bringing the authentic taste of Indian tea to your doorstep.
                Every cup is a journey through tradition and warmth.
              </p>
              {/* Social Links */}
              <div className="flex gap-4">
                <a
                  href="#"
                  className="w-10 h-10 bg-caramel/30 hover:bg-caramel rounded-full flex items-center justify-center transition-all transform hover:scale-110 shadow-lg"
                >
                  <svg
            ...
            {/* Quick Links */}
            <div>
              <h4 className="font-baloo text-lg font-bold text-beige mb-4">
                Quick Links
              </h4>
              <ul className="space-y-3">
                <li>
                  <a
                    href="#hero"
                    className="text-cream/80 hover:text-beige transition-colors text-sm sm:text-base"
                  >
                    Home
                  </a>
                </li>
          ...
          <div className="border-t border-caramel/30 mt-10 sm:mt-12 pt-6 sm:pt-8 text-center">
            <p className="text-cream/70 text-sm font-medium">
              © 2026 Millionaire Tea. All Rights Reserved.
            </p>{" "}
          </div>
        </div>
      </footer>
